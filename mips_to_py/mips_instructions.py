...
class Subtract:
    ...
    def sub_register_and_register(self, register_1, register_2):
    ...
    def mips_code(self):
        ...
        # 2 registers
            ...
            return self.sub_register_and_register(self.left_operand, self.right_operand)
...
class Divide:
    ...
    def sub_immediate_and_address(self, immediate, address):
        ...
        return f"""
                li $t8, {immediate}
                lw $t9, {address}
                div {self.destination}, {operand_registers}"""
